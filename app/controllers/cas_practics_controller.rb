class CasPracticsController < ApplicationController
  ...
  private
    ...
    def cas_practic_params
      params.require(:cas_practic).permit(:titol_ca, :resum_ca, :permalink_ca, :descripcio_ca, :emplacament_ca, :arquitectura_ca, :materials_ca, :energia_ca, :aigua_ca, :certificacions_ca, :arquitectes_ca, :emplacament_ca, :any_construccio_ca, :us_edifici_ca, :tipus_promocio_ca, :titol_es, :resum_es, :permalink_es, :descripcio_es, :emplacament_es, :arquitectura_es, :materials_es, :energia_es, :aigua_es, :certificacions_es, :arquitectes_es, :emplacament_es, :any_construccio_es, :us_edifici_es, :tipus_promocio_es)
    end
end
